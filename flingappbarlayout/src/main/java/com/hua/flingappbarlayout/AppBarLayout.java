...
package com.hua.flingappbarlayout;
...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, com.google.android.material.R.styleable.AppBarLayout,
        ...
        if (Build.VERSION.SDK_INT >= 21 && a.hasValue(com.google.android.material.R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(
                    this, a.getDimensionPixelSize(com.google.android.material.R.styleable.AppBarLayout_elevation, 0));
        }
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = mCollapsible ? com.google.android.material.R.attr.state_collapsible : -com.google.android.material.R.attr.state_collapsible;
        extraStates[1] = mCollapsible && mCollapsed
                ? com.google.android.material.R.attr.state_collapsed : -com.google.android.material.R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            mScrollFlags = a.getInt(com.google.android.material.R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
